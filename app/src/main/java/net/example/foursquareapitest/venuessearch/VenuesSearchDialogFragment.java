...
public class VenuesSearchDialogFragment extends DialogFragment {
     ...
     * @return the dialog
     */
    public static VenuesSearchDialogFragment newInstance(int title, int text, boolean showOkButton) {
        VenuesSearchDialogFragment frag = new VenuesSearchDialogFragment();
